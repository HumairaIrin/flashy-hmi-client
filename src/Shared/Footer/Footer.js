...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-black text-primary-content">
            <div>
                <img width="50" height="50" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" className="inline-block fill-current" src={image} alt="" />
                <p className="font-bold">
                    Flashy HMI. <br />Providing you services as best as I could.
                </p>
